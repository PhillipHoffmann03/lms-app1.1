...
class ExamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exam" do
    assert_difference("Exam.count") do
      post exams_url, params: { exam: { course_id: @exam.course_id, date: @exam.date, invigilator_id: @exam.invigilator_id, location: @exam.location } }
    end
  ...
  test "should update exam" do
    patch exam_url(@exam), params: { exam: { course_id: @exam.course_id, date: @exam.date, invigilator_id: @exam.invigilator_id, location: @exam.location } }
